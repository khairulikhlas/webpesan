...
const ARTI_GALAT = {
  ...
  130472: ['Nomor penerima masuk kelompok uji coba Meta', 'Meta sedang menahan pesan pemasaran ke sebagian pengguna sebagai percobaan. Di luar kendali kita, dan biasanya berubah sendiri. Tidak perlu tindakan apa pun.'],
  131053: ['WhatsApp gagal mengunduh gambar header', 'Server lambat menyajikan berkas saat broadcast berjalan. Minta Nginx menyajikan folder /media langsung dari disk, dan hindari me-restart aplikasi selagi broadcast berlangsung.'],
  131051: ['Jenis pesan tidak didukung', 'Periksa kembali jenis header template.'],
